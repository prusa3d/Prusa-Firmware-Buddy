...
#elif (BOARD_IS_XBUDDY && BOARD_VER_HIGHER_OR_EQUAL_TO(0, 2, 2) && defined LOVEBOARD_HAS_NTC)
    #define TEMP_SENSOR_0 2005
#elif BOARD_IS_XBUDDY && defined LOVEBOARD_HAS_NTC
...
#if (BOARD_IS_XBUDDY && BOARD_VER_HIGHER_THAN(0, 2, 1))
#define TEMP_SENSOR_BED 2004
#else
#define TEMP_SENSOR_BED 1
#endif
#if (BOARD_IS_XBUDDY && BOARD_VER_EQUAL_TO(0, 1, 8) && defined LOVEBOARD_HAS_PT100)
    #define TEMP_SENSOR_HEATBREAK 22
#else
...
#define BED_OFFSET_CENTER 50
    ...
    #define PT100_MAX_R 400
    #define PT100_MIN_R 50
#endif
...
#if (BOARD_IS_XBUDDY && BOARD_VER_HIGHER_OR_EQUAL_TO(0,2,0))
...
#if !defined(LOVEBOARD_HAS_PT100)
...
#if (BOARD_IS_XBUDDY && BOARD_VER_HIGHER_OR_EQUAL_TO(0,2,0) && !defined(HAS_PLANETARY_GEARBOX))
...
// MK426 (200 step motors) does not support precise homing
#if defined(HAS_LDO_400_STEP)
/**
