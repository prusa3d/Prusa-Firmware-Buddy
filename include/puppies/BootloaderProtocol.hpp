...
namespace puppies {
    ...
    public:
         ...
         * @param dataout data to send inside command
         * @param len length of data
         * @return status_t
         */
        status_t write_command(commands_t cmd, uint8_t *dataout, uint8_t len) const;
         ...
         *
         * @param cmd Command to send
         * @param wr_data Data to write with command
         ...
         */
        status_t run_transaction(commands_t cmd, uint8_t *wr_data, uint8_t wr_data_len, uint8_t *read_data = nullptr, size_t read_data_max = 0, size_t *read_data_len = nullptr, uint32_t read_timeout_response = READ_TIMEOUT_RESPONSE_DEFAULT) const;
         ...
         * @return status_t
         */
        status_t write_flash_cmd(uint32_t offset, uint8_t *data, uint8_t len) const;
         ...
         * @return status_t
         */
        status_t read_flash_cmd(uint32_t offset, uint8_t *data, uint8_t len) const;
         ...
         * @return status_t
         */
        status_t read_otp_cmd(uint32_t offset, uint8_t *dataout, uint8_t len) const;
         ...
         */
        status_t write_flash(uint32_t len, std::function<bool(uint32_t offset, size_t size, uint8_t *out_data)> get_data) const;
         ...
         * @return status_t
         */
        status_t get_protocolversion(uint16_t &version) const;
         ...
         * @return status_t
         */
        status_t get_hwinfo(HwInfo &hw_info) const;
         ...
         * @return status_t
         */
        status_t compute_fingerprint(uint32_t salt) const;
         ...
         * @return status_t
         */
        status_t get_fingerprint(fingerprint_t &fingerprint, uint8_t offset = 0, uint8_t size = sizeof(fingerprint_t)) const;
