...
set(TRANSLATIONS_ENABLED
    "NO"
    CACHE BOOL "Enable languages (NO == English only)"
    )
...
if(${PRINTER} STREQUAL "MK4" AND ${BOARD_VERSION} VERSION_LESS 0.2.0)
  message(STATUS "Disabling WUI and Connect for MK4 with 1MB chip")
  set(WUI NO)
  set(CONNECT NO)
endif()
...
if(${BOARD} STREQUAL "XBUDDY"
   AND ${BOARD_VERSION} VERSION_GREATER_EQUAL "0.2.2"
   AND PRINTER STREQUAL "MK4"
   )
  set(HAS_MMU2 YES)
else()
  set(HAS_MMU2 NO)
