...
#endif
#if BOTH(HAS_TEMP_BOARD_CONTROL, THERMAL_PROTECTION_BOARD) && WATCH_BOARD_TEMP_PERIOD > 0
  #define WATCH_BOARD 1
#endif
 ...
 */
    ...
    #define XY_PROBE_SPEED_INITIAL XY_PROBE_FEEDRATE
  #endif
#else
 ...
 */
  ...
  #endif
  #define Z_CLEARANCE_BETWEEN_MANUAL_PROBES std::max(Z_CLEARANCE_BETWEEN_PROBES, Z_HOMING_HEIGHT)
