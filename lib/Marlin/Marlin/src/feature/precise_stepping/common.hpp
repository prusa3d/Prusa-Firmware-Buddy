...
typedef struct step_generators_pool_t {
    classic_step_generator_t classic_step_generator_x = { { { .axis = X_AXIS } } };
    classic_step_generator_t classic_step_generator_y = { { { .axis = Y_AXIS } } };
    classic_step_generator_t classic_step_generator_z = { { { .axis = Z_AXIS } } };
    classic_step_generator_t classic_step_generator_e = { { { .axis = E_AXIS } } };

#ifdef ADVANCED_STEP_GENERATORS
    input_shaper_step_generator_t input_shaper_step_generator_x = { { { .axis = X_AXIS } } };
    input_shaper_step_generator_t input_shaper_step_generator_y = { { { .axis = Y_AXIS } } };
    input_shaper_step_generator_t input_shaper_step_generator_z = { { { .axis = Z_AXIS } } };
