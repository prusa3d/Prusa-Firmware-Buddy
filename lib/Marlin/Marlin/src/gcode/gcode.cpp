...
#include "../../../../../src/marlin_stubs/G26.hpp"
...
uint8_t GcodeSuite::axis_relative = ((ar_init.x ? _BV(REL_X) : 0)
...
void GcodeSuite::process_parsed_command(const bool no_ok /*=false*/) {
    ...
    case 'G':
        ...
        case 0:
        case 1:
            G0_G1( // G0: Fast Move, G1: Linear Move
    ...
    case 'M':
        ...
        case 876:
            M876();
            break; // M876: Handle Host prompt responses
    #endif
#else
        case 108:
        case 112:
    ...
    // PWM for HEATER_2_PIN
        ...
        case 86:
            M86();
            break; // M86: Set Safety Timer expiration time
        case 92:
            M92();
        ...
        case 666:
            M666();
            break; // M666: Set delta or dual endstop adjustment
#endif
        ...
        case 601:
            M601();
            break; // M601: Pause & park
        case 602:
            M602();
            break; // M602: Unpark & UnPause print
        case 603:
            M603();
        ...
        case 1000:
            M1000();
            break; // M1000: Resume from power-loss
#endif
