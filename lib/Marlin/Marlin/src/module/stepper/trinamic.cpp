...
#define TMC_INIT(ST, STEALTH_INDEX) tmc_init(stepper##ST, variant8_get_ui16(eeprom_get_var(AXIS_RMS_CURRENT_MA_##ST)), variant8_get_ui16(eeprom_get_var(AXIS_MICROSTEPS_##ST)), ST##_HYBRID_THRESHOLD, stealthchop_by_axis[STEALTH_INDEX], chopper_timing_##ST, ST##_INTERPOLATE, ST##_HOLD_MULTIPLIER)
