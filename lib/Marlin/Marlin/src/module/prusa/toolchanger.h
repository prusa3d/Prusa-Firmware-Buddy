...
public:
    ...
    static constexpr auto KENNEL_DEFAULT_Y_MM = 450.0f;
    static constexpr auto KENNEL_INVALID_OFFSET_MM = 5;
...
private:
    ...
    /**
     * @brief Move to a position with tool offset decompensated.
     * @param x move to this x [mm]
     * @param y move to this y [mm]
     * @param feedrate use this feedrate [mm/s]
     */
    void move(const float x, const float y, const feedRate_t feedrate);

    /**
     * @brief Move to a position with tool offset decompensated.
     * @param x move to this x [mm]
     * @param y move to this y [mm]
     * Use previously configured feedrate.
     */
