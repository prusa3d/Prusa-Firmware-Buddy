 ...
 */
PrusaAccelerometer::Acceleration AccelerometerUtils::unpack_sample(common::puppies::fifo::AccelerometerXyzSample sample) {
    ...
    accelerometer_sample.buffer_overflow = sample & buffer_overflow_mask;
