...
/**
  ...
  * @retval HAL status
  */
__weak HAL_StatusTypeDef HAL_RCC_OscConfig(RCC_OscInitTypeDef const  *RCC_OscInitStruct)
{
...
/**
  ...
  * @retval None
  */
HAL_StatusTypeDef HAL_RCC_ClockConfig(RCC_ClkInitTypeDef const *RCC_ClkInitStruct, uint32_t FLatency)
{
  uint32_t tickstart;
