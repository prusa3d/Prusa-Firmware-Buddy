...
#include "common.h"
    ...
    #if (defined(MBEDTLS_PSA_BUILTIN_KEY_TYPE_RSA_KEY_PAIR) || (defined(PSA_CRYPTO_DRIVER_TEST) && defined(MBEDTLS_PSA_ACCEL_KEY_TYPE_RSA_KEY_PAIR)))
        #define BUILTIN_KEY_TYPE_RSA_KEY_PAIR 1
    #endif

    #if (defined(MBEDTLS_PSA_BUILTIN_KEY_TYPE_RSA_PUBLIC_KEY) || (defined(PSA_CRYPTO_DRIVER_TEST) && defined(MBEDTLS_PSA_ACCEL_KEY_TYPE_RSA_PUBLIC_KEY)))
        #define BUILTIN_KEY_TYPE_RSA_PUBLIC_KEY 1
    #endif

    #if (defined(MBEDTLS_PSA_BUILTIN_ALG_RSA_PKCS1V15_SIGN) || (defined(PSA_CRYPTO_DRIVER_TEST) && defined(MBEDTLS_PSA_ACCEL_ALG_RSA_PKCS1V15_SIGN) && defined(MBEDTLS_RSA_C) && defined(MBEDTLS_PKCS1_V15)))
        #define BUILTIN_ALG_RSA_PKCS1V15_SIGN 1
    #endif

    #if (defined(MBEDTLS_PSA_BUILTIN_ALG_RSA_PSS) || (defined(PSA_CRYPTO_DRIVER_TEST) && defined(MBEDTLS_PSA_ACCEL_ALG_RSA_PSS) && defined(MBEDTLS_RSA_C) && defined(MBEDTLS_PKCS1_V21)))
        #define BUILTIN_ALG_RSA_PSS 1
    #endif

    #if defined(MBEDTLS_PSA_BUILTIN_ALG_RSA_PKCS1V15_CRYPT) || defined(MBEDTLS_PSA_BUILTIN_ALG_RSA_OAEP) || defined(BUILTIN_ALG_RSA_PKCS1V15_SIGN) || defined(BUILTIN_ALG_RSA_PSS) || defined(BUILTIN_KEY_TYPE_RSA_KEY_PAIR) || defined(BUILTIN_KEY_TYPE_RSA_PUBLIC_KEY)
...
exit:
    ...
    #if defined(BUILTIN_KEY_TYPE_RSA_KEY_PAIR) || defined(BUILTIN_KEY_TYPE_RSA_PUBLIC_KEY)
 ...
 */
        ...
        #if defined(MBEDTLS_PSA_ACCEL_KEY_TYPE_RSA_KEY_PAIR) || defined(MBEDTLS_PSA_ACCEL_KEY_TYPE_RSA_PUBLIC_KEY)
...
psa_status_t mbedtls_transparent_test_driver_rsa_generate_key(
    ...
    return (rsa_generate_key(attributes, key_buffer, key_buffer_size,
        ...
        #if defined(MBEDTLS_PSA_ACCEL_ALG_RSA_PKCS1V15_SIGN) || defined(MBEDTLS_PSA_ACCEL_ALG_RSA_PSS)
psa_status_t mbedtls_transparent_test_driver_rsa_sign_hash(
    const psa_key_attributes_t *attributes,
    const uint8_t *key_buffer, size_t key_buffer_size,
    psa_algorithm_t alg, const uint8_t *hash, size_t hash_length,
    uint8_t *signature, size_t signature_size, size_t *signature_length) {
            #if defined(MBEDTLS_RSA_C) && (defined(MBEDTLS_PKCS1_V15) || defined(MBEDTLS_PKCS1_V21))
    return (rsa_sign_hash(
        attributes,
        key_buffer, key_buffer_size,
        alg, hash, hash_length,
