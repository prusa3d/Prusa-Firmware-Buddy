...
#include "common.h"
    ...
    #if (defined(MBEDTLS_PSA_BUILTIN_KEY_TYPE_ECC_KEY_PAIR) || (defined(PSA_CRYPTO_DRIVER_TEST) && defined(MBEDTLS_PSA_ACCEL_KEY_TYPE_ECC_KEY_PAIR)))
        #define BUILTIN_KEY_TYPE_ECC_KEY_PAIR 1
    #endif

    #if (defined(MBEDTLS_PSA_BUILTIN_KEY_TYPE_ECC_PUBLIC_KEY) || (defined(PSA_CRYPTO_DRIVER_TEST) && defined(MBEDTLS_PSA_ACCEL_KEY_TYPE_ECC_PUBLIC_KEY)))
        #define BUILTIN_KEY_TYPE_ECC_PUBLIC_KEY 1
    #endif

    #if (defined(MBEDTLS_PSA_BUILTIN_ALG_ECDSA) || (defined(PSA_CRYPTO_DRIVER_TEST) && defined(MBEDTLS_PSA_ACCEL_ALG_ECDSA) && defined(MBEDTLS_ECDSA_C)))
        #define BUILTIN_ALG_ECDSA 1
    #endif

    #if (defined(MBEDTLS_PSA_BUILTIN_ALG_DETERMINISTIC_ECDSA) || (defined(PSA_CRYPTO_DRIVER_TEST) && defined(MBEDTLS_PSA_ACCEL_ALG_DETERMINISTIC_ECDSA) && defined(MBEDTLS_ECDSA_C) && defined(MBEDTLS_ECDSA_DETERMINISTIC)))
        #define BUILTIN_ALG_DETERMINISTIC_ECDSA 1
    #endif

    #if defined(BUILTIN_KEY_TYPE_ECC_KEY_PAIR) || defined(BUILTIN_KEY_TYPE_ECC_PUBLIC_KEY) || defined(BUILTIN_ALG_ECDSA) || defined(BUILTIN_ALG_DETERMINISTIC_ECDSA) || defined(MBEDTLS_PSA_BUILTIN_ALG_ECDH)
