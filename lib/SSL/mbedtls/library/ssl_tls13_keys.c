...
static const char tls1_3_label_prefix[6] = "tls13 ";
    ...
    #define SSL_TLS1_3_KEY_SCHEDULE_MAX_HKDF_LABEL_LEN                                   \
        SSL_TLS1_3_KEY_SCHEDULE_HKDF_LABEL_LEN(                                          \
            sizeof(tls1_3_label_prefix) + MBEDTLS_SSL_TLS1_3_KEY_SCHEDULE_MAX_LABEL_LEN, \
            MBEDTLS_SSL_TLS1_3_KEY_SCHEDULE_MAX_CONTEXT_LEN)
...
static void ssl_tls1_3_hkdf_encode_label(
    ...
    size_t total_hkdf_lbl_len = SSL_TLS1_3_KEY_SCHEDULE_HKDF_LABEL_LEN(total_label_len, clen);
