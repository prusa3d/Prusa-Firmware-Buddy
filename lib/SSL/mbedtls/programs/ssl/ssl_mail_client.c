...
#if !defined(MBEDTLS_BIGNUM_C) || !defined(MBEDTLS_ENTROPY_C) || !defined(MBEDTLS_SSL_TLS_C) || !defined(MBEDTLS_SSL_CLI_C) || !defined(MBEDTLS_NET_C) || !defined(MBEDTLS_RSA_C) || !defined(MBEDTLS_CTR_DRBG_C) || !defined(MBEDTLS_X509_CRT_PARSE_C) || !defined(MBEDTLS_FS_IO)
int main(void) {
...
int main(int argc, char *argv[]) {
    ...
    if ((ret = mbedtls_net_connect(&server_fd, opt.server_name,
             opt.server_port, MBEDTLS_NET_PROTO_TCP))
        != 0) {
