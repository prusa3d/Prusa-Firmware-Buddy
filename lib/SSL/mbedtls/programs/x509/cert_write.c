...
#if !defined(MBEDTLS_X509_CRT_WRITE_C) || !defined(MBEDTLS_X509_CRT_PARSE_C) || !defined(MBEDTLS_FS_IO) || !defined(MBEDTLS_ENTROPY_C) || !defined(MBEDTLS_CTR_DRBG_C) || !defined(MBEDTLS_ERROR_C) || !defined(MBEDTLS_SHA256_C) || !defined(MBEDTLS_PEM_WRITE_C)
int main(void) {
