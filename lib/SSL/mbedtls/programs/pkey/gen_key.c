...
#if !defined(MBEDTLS_PK_WRITE_C) || !defined(MBEDTLS_PEM_WRITE_C) || !defined(MBEDTLS_FS_IO) || !defined(MBEDTLS_ENTROPY_C) || !defined(MBEDTLS_CTR_DRBG_C)
int main(void) {
...
int main(int argc, char *argv[]) {
    ...
    if ((ret = mbedtls_pk_setup(&key,
             mbedtls_pk_info_from_type((mbedtls_pk_type_t)opt.type)))
        != 0) {
