...
#if defined(MBEDTLS_ECDSA_C) && defined(MBEDTLS_ENTROPY_C) && defined(MBEDTLS_CTR_DRBG_C)
...
#if !defined(MBEDTLS_ECDSA_C) || !defined(MBEDTLS_SHA256_C) || !defined(MBEDTLS_ENTROPY_C) || !defined(MBEDTLS_CTR_DRBG_C)
int main(void) {
