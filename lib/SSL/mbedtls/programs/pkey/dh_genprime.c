...
#if !defined(MBEDTLS_BIGNUM_C) || !defined(MBEDTLS_ENTROPY_C) || !defined(MBEDTLS_FS_IO) || !defined(MBEDTLS_CTR_DRBG_C) || !defined(MBEDTLS_GENPRIME)
int main(void) {
...
int main(int argc, char **argv) {
    ...
    if ((ret = mbedtls_mpi_write_file("P = ", &P, 16, fout) != 0) || (ret = mbedtls_mpi_write_file("G = ", &G, 16, fout) != 0)) {
