 ...
 */
    ...
    #define MBEDTLS_TEST_PSA_SKIP_IF_ALT_AES_192(key_type, key_bits)                                    \
        do {                                                                                            \
            if ((MBEDTLS_TEST_HAVE_ALT_AES) && ((key_type) == PSA_KEY_TYPE_AES) && (key_bits == 192)) { \
 ...
 */
    ...
    #define MBEDTLS_TEST_PSA_SKIP_IF_ALT_GCM_NOT_12BYTES_NONCE(alg,                                                                                                        \
        nonce_length)                                                                                                                                                      \
        do {                                                                                                                                                               \
            if ((MBEDTLS_TEST_HAVE_ALT_GCM) && (PSA_ALG_AEAD_WITH_SHORTENED_TAG((alg), 0) == PSA_ALG_AEAD_WITH_SHORTENED_TAG(PSA_ALG_GCM, 0)) && ((nonce_length) != 12)) { \
