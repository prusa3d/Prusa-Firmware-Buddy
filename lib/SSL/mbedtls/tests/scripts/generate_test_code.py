...
def read_code_from_input_files(platform_file, helpers_file, out_data_file,
                               snippets):
    """
...
def generate_code(**input_info):
    ...
    read_code_from_input_files(platform_file, helpers_file, out_data_file,
                               snippets)
...
def main():
    ...
    generate_code(funcs_file=args.funcs_file,
