...
class GenDepOneLine(TestCase):
    ...
    def test_large_dependencies_list(self):
        ...
        dep_str = gen_dependencies_one_line(dependencies)
        expected = '#if ' + ' && '.join(
            ['defined(%s)' % x for x in dependencies])
...
'''
    ...
    def test_local(self):
        ...
        :return:
        """
        code = gen_function_wrapper('test_a', 'int x = 1;',
                                    ('x', 'b', 'c', 'd'))
        expected = '''
void test_a_wrapper( void ** params )
{
...
class ParseFuncSignature(TestCase):
    ...
    def test_hex_params(self):
        ...
        self.assertEqual(
            local, '    data_t data1 = {(uint8_t *) params[1], '
            '*( (uint32_t *) params[2] )};\n')
        self.assertEqual(
            arg_dispatch,
            ['(char *) params[0]', '&data1', '*( (int *) params[3] )'])
...
'''
    ...
    def test_return(self, parse_function_arguments_mock,
                    gen_function_wrapper_mock, gen_dependencies_mock,
                    gen_dispatch_mock):
        """
        Test generated code.
        :return:
...
'''
    ...
    def test_functio_name_on_newline(self, parse_function_arguments_mock,
                                     ...
                                     gen_dependencies_mock, gen_dispatch_mock):
        """
        Test when exit label is present.
        :return:
        """
...
class EscapedSplit(TestCase):
    ...
    def test_all_at_once(self):
        ...
        splits = escaped_split(test_str, ':')
        self.assertEqual(splits, [
            r'yahoo\\', r'google', r'facebook\:instagram\\', r'bbc\\',
            r'wikipedia'
        ])
...
"""
        ...
        self.assertEqual(test2[3], [
            '10', '"93450983094850938450983409623"', '10',
        ...
        self.assertEqual(test3[3], [
            '10', '"9345098382739712938719287391879381271"', '10',
...
class GenExpCheck(TestCase):
    ...
    def test_negative_exp_id(self):
        ...
        :return:
        """
        self.assertRaises(GeneratorInputError, gen_expression_check, -1,
                          'YAHOO')
...
class WriteParams(TestCase):
    ...
    def test_with_exp_param(self):
        ...
        expression_code = write_parameters(
            ...
            ['char*', 'hex', 'int', 'int', 'int', 'int'], unique_expressions)
    ...
    def test_with_repeat_calls(self):
        ...
        expression_code += write_parameters(stream,
                                            ...
                                            ['hex', 'int', 'int'],
                                            unique_expressions)
        expression_code += write_parameters(stream, ['0', 'MACRO3', 'MACRO1'],
                                            ['int', 'int', 'int'],
                                            unique_expressions)
        self.assertEqual(len(unique_expressions), 3)
        self.assertEqual(unique_expressions, ['MACRO1', 'MACRO2', 'MACRO3'])
...
class GenFromTestData(TestCase):
    ...
    def test_intermediate_data_file(func_mock1, write_parameters_mock,
...
'''
        ...
        write_dependencies_mock.assert_called_with(out_data_f, ['DEP1'],
                                                   ['DEP1'])
        ...
        case 0:
            ...
            break;'''
        func_mock1.assert_called_with(suite_dependencies,
                                      expected_dep_check_code, '')
