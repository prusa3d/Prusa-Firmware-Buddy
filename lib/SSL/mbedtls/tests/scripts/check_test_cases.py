...
"""
    ...
    def process_test_case(self, per_file_state, file_name, line_number,
                          description):
        """Process a test case.
        ...
        with open(data_file_name, 'rb') as data_file:
            for line_number, line in enumerate(data_file, 1):
                ...
                if not in_paragraph:
                    ...
                    self.process_test_case(descriptions, data_file_name,
                                           line_number, line)
                in_paragraph = True
    ...
    def walk_ssl_opt_sh(self, file_name):
        ...
        with open(file_name, 'rb') as file_contents:
            for line_number, line in enumerate(file_contents, 1):
                ...
                self.process_test_case(descriptions, file_name, line_number,
                                       description)
