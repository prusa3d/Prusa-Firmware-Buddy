 ...
 * situations. */
    #if defined(PSA_HAVE_SOFT_KEY_TYPE_AES) || defined(PSA_HAVE_SOFT_KEY_TYPE_DES) || defined(PSA_HAVE_SOFT_KEY_TYPE_CAMELLIA)
 ...
 */
    ...
    #if defined(MBEDTLS_AES_C) || defined(MBEDTLS_DES_C) || defined(MBEDTLS_CAMELLIA_C)
        #define MBEDTLS_PSA_BUILTIN_ALG_ECB_NO_PADDING 1
