...
typedef enum {
    ...
    mpsFinished,
    marlin_print_state_t::CrashRecovery_Begin,
    marlin_print_state_t::CrashRecovery_Retracting,
    marlin_print_state_t::CrashRecovery_Lifting,
    marlin_print_state_t::CrashRecovery_XY_Measure,
    marlin_print_state_t::CrashRecovery_XY_HOME,
    marlin_print_state_t::CrashRecovery_Axis_NOK,
    marlin_print_state_t::CrashRecovery_Repeated_Crash,
    marlin_print_state_t::PowerPanic_acFault,
    marlin_print_state_t::PowerPanic_Resume,
    marlin_print_state_t::PowerPanic_AwaitingResume,
