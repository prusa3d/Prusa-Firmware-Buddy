...
#ifdef _DEBUG
using Screen = screen_menu_data_t<EHeader::Off, EFooter::On, EHelp::Off, MI_RETURN, MI_STATISTIC_disabled, MI_SYS_INFO, MI_FAIL_STAT_disabled,
    MI_SUPPORT_disabled, MI_VERSION_INFO, MI_QR_info, MI_QR_test>;
#else
using Screen = screen_menu_data_t<EHeader::Off, EFooter::On, EHelp::Off, MI_RETURN, MI_SYS_INFO, MI_VERSION_INFO>;
#endif //_DEBUG
