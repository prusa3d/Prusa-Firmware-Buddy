...
#ifdef _DEBUG
using Screen = ScreenMenu<EFooter::On, MI_RETURN, MI_STATISTIC_disabled, MI_SYS_INFO, MI_FAIL_STAT_disabled,
    MI_SUPPORT_disabled, MI_SENSOR_INFO, MI_VERSION_INFO>;
#else
using Screen = ScreenMenu<EFooter::On, MI_RETURN, MI_SYS_INFO, MI_SENSOR_INFO, MI_VERSION_INFO>;
#endif //_DEBUG
