...
screen_splash_data_t::screen_splash_data_t()
    ...
    , logo_prusa_mini(this, Rect16(0, 84, 240, 62), { PNG::prusa_printer_splash })
    ...
    , icon_logo_buddy(this, Rect16(), png::Id::Null())  //unused?
    , icon_logo_marlin(this, Rect16(), png::Id::Null()) //unused?
