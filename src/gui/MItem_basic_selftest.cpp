...
MI_CALIB_FIRST::MI_CALIB_FIRST()
    : WI_LABEL_t(_(label), png::Id::Null(), is_enabled_t::yes, PRINTER_TYPE == PRINTER_PRUSA_MINI ? is_hidden_t::no : is_hidden_t::dev) {
}
...
//MI_TEST_X
MI_TEST_X::MI_TEST_X()
    : WI_LABEL_t(string_view_utf8::MakeCPUFLASH((uint8_t *)label), png::Id::Null(), is_enabled_t::yes, is_hidden_t::dev) {
}
