...
MI_LangBase::MI_LangBase(const char *label, const img::Resource *icon)
...
MI_ENGLISH::MI_ENGLISH()
    : MI_LangBase(label, &img::flag_en_16x11) {}
...
MI_CZECH::MI_CZECH()
    : MI_LangBase(label, &img::flag_cs_16x11) {}
...
MI_GERMAN::MI_GERMAN()
    : MI_LangBase(label, &img::flag_de_16x11) {}
...
MI_SPANISH::MI_SPANISH()
    : MI_LangBase(label, &img::flag_es_16x11) {}
...
MI_FRENCH::MI_FRENCH()
    : MI_LangBase(label, &img::flag_fr_16x11) {}
...
MI_ITALIAN::MI_ITALIAN()
    : MI_LangBase(label, &img::flag_it_16x11) {}
...
MI_POLISH::MI_POLISH()
    : MI_LangBase(label, &img::flag_pl_16x11) {}
