...
public:
    ...
    IFooterIconText(window_t *parent, png::Id icon, Rect16::W_t width); //icon width is calculated from resource
    IFooterIconText(window_t *parent, png::Id icon, string_view_utf8 view);
};
...
public:
    FooterIconText_IntVal(window_t *parent, png::Id icon, view_maker_cb view_maker, reader_cb value_reader);
};
...
protected:
    ...
    virtual changed_t updateValue() override;
    virtual resized_t updateState() override;
    static Rect16::Width_t GetTotalWidth(png::Id icon, string_view_utf8 view);

public:
    FooterIconText_FloatVal(window_t *parent, png::Id icon, view_maker_cb view_maker, reader_cb value_reader);
};
