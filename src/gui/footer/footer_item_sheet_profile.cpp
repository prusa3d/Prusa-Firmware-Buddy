...
#include "resource.h"       // PNG::sheets_profile_16x14
#include "SteelSheets.hpp"

FooterItemSheets::FooterItemSheets(window_t *parent)
    : AddSuperWindow<FooterIconText_IntVal>(parent, png::Id({ PNG::sheets_profile_16x14 }), static_makeView, static_readValue) {
}
