...
IFooterItemFan::IFooterItemFan(window_t *parent, png::Id icon_id, view_maker_cb view_maker, reader_cb value_reader)
...
FooterItemPrintFan::FooterItemPrintFan(window_t *parent)
    : AddSuperWindow<IFooterItemFan>(parent, png::Id({ IDR_PNG_turbine_16x16 }), static_makeView, static_readValue) {
}
...
FooterItemHeatBreakFan::FooterItemHeatBreakFan(window_t *parent)
    : AddSuperWindow<IFooterItemFan>(parent, png::Id({ IDR_PNG_fan_16x16 }), static_makeView, static_readValue) {
}
