...
public:
    MI_AXIS<INDEX, LONG_SEG, BUFFER_LEN>()
        : WiSpinInt(int32_t(marlin_vars()->pos[INDEX]),
            SpinCnf::axis_ranges[INDEX], _(MenuVars::labels[INDEX]), png::Id::Null(), is_enabled_t::yes, is_hidden_t::no)
...
public:
    ...
    DUMMY_AXIS_E()
        : WI_FORMATABLE_LABEL_t<int>(_(MenuVars::labels[MARLIN_VAR_INDEX_E]), png::Id::Null(), is_enabled_t::yes, is_hidden_t::no, 0,
