...
MI_FAIL_STAT_disabled::MI_FAIL_STAT_disabled()
    : WI_LABEL_t(_(label), png::Id::Null(), is_enabled_t::no, is_hidden_t::no) {
}
...
MI_ETH_SETTINGS::MI_ETH_SETTINGS()
    : WI_LABEL_t(_(label), png::Id::Null(), is_enabled_t::yes, is_hidden_t::no, expands_t::yes) {
...
MI_CURRENT_PROFILE::MI_CURRENT_PROFILE()
    : WI_LABEL_t(_(label), png::Id::Null(), is_enabled_t::yes, SteelSheets::NumOfCalibrated() > 1 ? is_hidden_t::no : is_hidden_t::yes) {
...
MI_DEVHASH_IN_QR::MI_DEVHASH_IN_QR()
    : WI_SWITCH_OFF_ON_t(eeprom_get_bool(EEVAR_DEVHASH_IN_QR), _(label), png::Id::Null(), is_enabled_t::yes, is_hidden_t::no) {}
...
MI_EEPROM_DIAGNOSTICS::MI_EEPROM_DIAGNOSTICS()
    : WI_LABEL_t(_(label), png::Id::Null(), is_enabled_t::yes, is_hidden_t::dev, expands_t::yes) {
}
...
MI_USB_MSC_ENABLE::MI_USB_MSC_ENABLE()
    : WI_SWITCH_OFF_ON_t(eeprom_get_bool(EEVAR_USB_MSC_ENABLED), _(label), png::Id::Null(), is_enabled_t::yes, is_hidden_t::dev) {}
