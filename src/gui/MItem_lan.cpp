...
MI_NET_INTERFACE_t::MI_NET_INTERFACE_t()
    : WI_SWITCH_t(0, string_view_utf8::MakeCPUFLASH((const uint8_t *)label), png::Id::Null(), is_enabled_t::yes, is_hidden_t::no, string_view_utf8::MakeCPUFLASH((const uint8_t *)str_off), string_view_utf8::MakeCPUFLASH((const uint8_t *)str_eth), string_view_utf8::MakeCPUFLASH((const uint8_t *)str_wifi)) {
...
MI_NET_IP_t::MI_NET_IP_t()
    : WI_SWITCH_t(0, string_view_utf8::MakeCPUFLASH((const uint8_t *)label), png::Id::Null(), is_enabled_t::yes, is_hidden_t::no, string_view_utf8::MakeCPUFLASH((const uint8_t *)str_DHCP), string_view_utf8::MakeCPUFLASH((const uint8_t *)str_static)) {
...
MI_NET_IP_VER_t::MI_NET_IP_VER_t()
    : WI_SWITCH_t(0, string_view_utf8::MakeCPUFLASH((const uint8_t *)label), png::Id::Null(), is_enabled_t::no, is_hidden_t::no, string_view_utf8::MakeCPUFLASH((const uint8_t *)str_v4), string_view_utf8::MakeCPUFLASH((const uint8_t *)str_v6)) {
    this->index = 0;
}

MI_IP4_ADDR::MI_IP4_ADDR()
    : WiInfo<ADDR_LEN>(_(label), png::Id::Null(), is_enabled_t::yes, is_hidden_t::no) {
}
...
MI_MAC_ADDR::MI_MAC_ADDR()
    : WiInfo<MAC_LEN>(_(label), png::Id::Null(), is_enabled_t::yes, is_hidden_t::no) {
}
