...
using ScreenMenuEthernetSettings_ = ScreenMenu<EFooter::Off, MI_RETURN, //
    MI_NET_IP_VER_t, WMI_NET<MI_NET_IP, NETDEV_ETH_ID>, WMI_NET<MI_IP4_ADDR, NETDEV_ETH_ID>, WMI_NET<MI_IP4_NMSK, NETDEV_ETH_ID>, WMI_NET<MI_IP4_GWAY, NETDEV_ETH_ID>, WMI_NET<MI_HOSTNAME, NETDEV_ETH_ID>, WMI_NET<MI_MAC_ADDR, NETDEV_ETH_ID>>;
...
using ScreenMenuWifiSettings_ = ScreenMenu<EFooter::Off, MI_RETURN, //
    ...
    MI_NET_IP_VER_t, WMI_NET<MI_NET_IP, NETDEV_ESP_ID>, WMI_NET<MI_IP4_ADDR, NETDEV_ESP_ID>, WMI_NET<MI_IP4_NMSK, NETDEV_ESP_ID>, WMI_NET<MI_IP4_GWAY, NETDEV_ESP_ID>, WMI_NET<MI_HOSTNAME, NETDEV_ESP_ID>, WMI_NET<MI_MAC_ADDR, NETDEV_ESP_ID>>;
