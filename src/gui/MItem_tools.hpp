...
public:
    MI_FILAMENT_SENSOR()
        : WI_SWITCH_OFF_ON_t(init_index(), _(label), png::Id::Null(), is_enabled_t::yes, is_hidden_t::no) {}
...
public:
    MI_ODOMETER_DIST(string_view_utf8 label, png::Id id_icon, is_enabled_t enabled, is_hidden_t hidden, float initVal);
};
