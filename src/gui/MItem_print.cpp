...
MI_NOZZLE::MI_NOZZLE()
    : WiSpinInt(uint16_t(marlin_vars()->target_nozzle),
        SpinCnf::nozzle, _(label), png::Id::Null(), is_enabled_t::yes, is_hidden_t::no) {}
...
MI_HEATBED::MI_HEATBED()
    : WiSpinInt(uint8_t(marlin_vars()->target_bed),
        SpinCnf::bed, _(label), png::Id::Null(), is_enabled_t::yes, is_hidden_t::no) {}
...
MI_PRINTFAN::MI_PRINTFAN()
    : WiSpinInt(uint8_t(marlin_vars()->print_fan_speed),
        SpinCnf::printfan, _(label), png::Id::Null(), is_enabled_t::yes, is_hidden_t::no) {}
...
MI_SPEED::MI_SPEED()
    : WiSpinInt(uint16_t(marlin_vars()->print_speed),
        SpinCnf::feedrate, _(label), png::Id::Null(), is_enabled_t::yes, is_hidden_t::no) {}
...
MI_FLOWFACT::MI_FLOWFACT()
    : WiSpinInt(uint16_t(marlin_vars()->flow_factor),
        SpinCnf::flowfact, _(label), png::Id::Null(), is_enabled_t::yes, is_hidden_t::no) {}
