/**
 * @file
 * @brief Menu diagnostics for iX printer
 */
...
using ScreenMenuDiagnostics__ = ScreenMenu<GuiDefaults::MenuFooter, MI_RETURN, MI_MESH_BED, MI_TEST_FANS,
    MI_TEST_XYZ, MI_TEST_X, MI_TEST_Y, MI_TEST_HEAT, MI_TEST_HOTEND, MI_TEST_LOADCELL, MI_SELFTEST_RESULT, MI_ADVANCED_FAN_TEST>;
