...
status_footer_t::status_footer_t(window_t *parent)
    ...
    , wt_nozzle(this, Rect16(24, 269, 85, 20))
    , wt_heatbed(this, Rect16(150, 269, 85, 22))
    , wt_prnspeed(this, Rect16(28, 296, 40, 22))
    , wt_z_axis(this, Rect16(102, 296, 58, 22))
    , wt_filament(this, Rect16(181, 296, 49, 22))
    , nozzle(-273)
    , nozzle_target(-273)
