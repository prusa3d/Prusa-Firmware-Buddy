...
void MI_DOCK_CALIBRATE::click([[maybe_unused]] IWindowMenu &window_menu) {
    marlin_client::test_start_for_tools(stmDocks, static_cast<ToolMask>(1 << displayed_tool));
}
...
void MI_FSENSORS_CALIBRATE::click([[maybe_unused]] IWindowMenu &window_menu) {
    ...
    marlin_client::test_start_for_tools(stmFSensor, static_cast<ToolMask>(1 << displayed_tool));
}
