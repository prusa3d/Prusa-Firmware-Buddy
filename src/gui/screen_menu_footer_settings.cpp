...
public:
    IMiFooter()
        : WI_SWITCH_t(size_t(StatusFooter::GetSlotInit(INDEX)),
            ...
            png::Id::Null(), is_enabled_t::yes, is_hidden_t::no,
...
public:
    MI_LEFT_ALIGN_TEMP()
        : WI_SWITCH_t(size_t(FooterItemHeater::GetDrawType()),
            string_view_utf8::MakeCPUFLASH((const uint8_t *)label), png::Id::Null(), is_enabled_t::yes, is_hidden_t::no,
...
public:
    MI_FOOTER_CENTER_N()
        : WiSpinInt(uint8_t(FooterLine::GetCenterN()),
            SpinCnf::footer_center_N_range, _(label), png::Id::Null(), is_enabled_t::yes, is_hidden_t::no) {}
