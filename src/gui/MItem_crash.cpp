...
MI_CRASH_DETECTION::MI_CRASH_DETECTION()
    : WI_SWITCH_OFF_ON_t(0, _(label), png::Id::Null(), is_enabled_t::yes, is_hidden_t::no) {
...
MI_CRASH_SENSITIVITY_X::MI_CRASH_SENSITIVITY_X()
    : WiSpinInt(crash_s.get_sensitivity().x, SpinCnf::crash_sensitivity_2209, _(label), png::Id::Null(), is_enabled_t::yes, is_hidden_t::dev) {
}
...
MI_CRASH_SENSITIVITY_Y::MI_CRASH_SENSITIVITY_Y()
    : WiSpinInt(crash_s.get_sensitivity().y, SpinCnf::crash_sensitivity_2209, _(label), png::Id::Null(), is_enabled_t::yes, is_hidden_t::dev) {
}
...
MI_CRASH_MAX_PERIOD_X::MI_CRASH_MAX_PERIOD_X()
    : WI_SPIN_CRASH_PERIOD_t(crash_s.get_max_period().x, SpinCnf::crash_max_period_2209, _(label), png::Id::Null(), is_enabled_t::yes, is_hidden_t::dev) {
}
...
MI_CRASH_MAX_PERIOD_Y::MI_CRASH_MAX_PERIOD_Y()
    : WI_SPIN_CRASH_PERIOD_t(crash_s.get_max_period().y, SpinCnf::crash_max_period_2209, _(label), png::Id::Null(), is_enabled_t::yes, is_hidden_t::dev) {
}
...
MI_CRASH_FILTERING::MI_CRASH_FILTERING()
    : WI_SWITCH_OFF_ON_t(0, _(label), png::Id::Null(), is_enabled_t::yes, is_hidden_t::dev) {
