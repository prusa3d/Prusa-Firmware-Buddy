...
void update_firmware_screen(void) {
    ...
    render_icon_align(Rect16(70, 20, 100, 100), IDR_PNG_pepa_64px, color_t::Black, Align_t::Center());
    ...
    render_text_align(Rect16(5, 250, 230, 40), _("RESET PRINTER"), font1, color_t::Orange, color_t::White, { 2, 6, 2, 2 }, Align_t::Center());
    BtnState_t btn_ev;
    while (1) {
