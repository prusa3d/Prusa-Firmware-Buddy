...
extern "C" dlg_result_t gui_dlg_load(void) {
...
extern "C" dlg_result_t gui_dlg_purge(void) {
    //todo must be called inside _gui_dlg, but nested dialogs are not supported now
...
extern "C" dlg_result_t gui_dlg_load_forced(void) {
    //todo must be called inside _gui_dlg, but nested dialogs are not supported now
...
extern "C" dlg_result_t gui_dlg_unload(void) {
    //todo must be called inside _gui_dlg, but nested dialogs are not supported now
...
extern "C" dlg_result_t gui_dlg_unload_forced(void) {
    //todo must be called inside _gui_dlg, but nested dialogs are not supported now
