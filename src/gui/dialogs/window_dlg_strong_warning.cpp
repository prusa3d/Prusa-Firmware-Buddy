...
// window_dlg_strong_warning_t::responses = { }

const PhaseResponses dlg_responses = { Response::_none, Response::_none, Response::_none, Response::_none };
...
window_dlg_strong_warning_t::window_dlg_strong_warning_t()
    ...
    , text(this, { 0, 104, 240, 120 }, is_multiline::yes, is_closed_on_click_t::no)
    , button(this, get_radio_button_rect(rect), &dlg_responses, &ph_txt_continue) {
    header.SetText(_("INFO"));
    button.rect -= Rect16::Top_t(64);
}
