...
struct MenuVars {
    ...
    static const std::array<int32_t, AXIS_CNT> default_steps_per_unit;
    static const std::array<int32_t, AXIS_CNT> default_microsteps;
    static const std::array<int32_t, AXIS_CNT> default_currents;

    static const std::array<int32_t, MenuVars::RANGE_SZ> maximum_z_axis_range;
    static const std::array<std::array<int32_t, RANGE_SZ>, AXIS_CNT> axis_ranges;
    static const std::array<std::array<int32_t, RANGE_SZ>, AXIS_CNT> steps_per_unit_ranges;
    static const std::array<std::array<int32_t, RANGE_SZ>, AXIS_CNT> axis_rms_currents_ranges;
    ...
    constexpr static std::array<int32_t, MenuVars::RANGE_SZ> microstep_exponential_range = { 0, 8, 2 }; // 2^0 - 2^8 .. 1, 2, 4, .. , 128, 256
    constexpr static std::array<int32_t, MenuVars::RANGE_SZ> axis_rms_currents_range = { 0, 800, 1 };
    constexpr static std::array<int32_t, MenuVars::RANGE_SZ> steps_per_unit_range = { 1, 1000, 1 }; // small range, experimental feature
    //todo make constexpr
