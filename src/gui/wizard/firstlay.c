...
const char *V2_gcodes_body[] = {
    ...
    "G1 F1000",
    "G1 X30  Y30.0  E0.832", //20 * 0.2 * 0.5 / (pi * 1.75 ^ 2 / 4) = 0.832
    "G1 X30  Y29.5  E0.0208", //0.5 * 0.2 * 0.5 / (pi * 1.75 ^ 2 / 4) = 0.0208
    "G1 X10  Y29.5  E0.832",
    "G1 X10  Y29.0  E0.0208",
    "G1 X30  Y29.0  E0.832",
    "G1 X30  Y28.5  E0.0208",
    "G1 X10  Y28.5  E0.832",
    "G1 X10  Y28.0  E0.0208",
    "G1 X30  Y28.0  E0.832",
    "G1 X30  Y27.5  E0.0208",
    "G1 X10  Y27.5  E0.832",
    "G1 X10  Y27.0  E0.0208",
    "G1 X30  Y27.0  E0.832",
    "G1 X30  Y26.5  E0.0208",
    "G1 X10  Y26.5  E0.832",
    "G1 X10  Y26.0  E0.0208",
    "G1 X30  Y26.0  E0.832",
    "G1 X30  Y25.5  E0.0208",
    "G1 X10  Y25.5  E0.832",
    "G1 X10  Y25.0  E0.0208",
    "G1 X30  Y25.0  E0.832",
    "G1 X30  Y24.5  E0.0208",
    "G1 X10  Y24.5  E0.832",
    "G1 X10  Y24.0  E0.0208",
    "G1 X30  Y24.0  E0.832",
    "G1 X30  Y23.5  E0.0208",
    "G1 X10  Y23.5  E0.832",
    "G1 X10  Y23.0  E0.0208",
    "G1 X30  Y23.0  E0.832",
    "G1 X30  Y22.5  E0.0208",
    "G1 X10  Y22.5  E0.832",
    "G1 X10  Y22.0  E0.0208",
    "G1 X30  Y22.0  E0.832",
    "G1 X30  Y21.5  E0.0208",
    "G1 X10  Y21.5  E0.832",
    "G1 X10  Y21.0  E0.0208",
    "G1 X30  Y21.0  E0.832",
    "G1 X30  Y20.5  E0.0208",
    "G1 X10  Y20.5  E0.832",
    "G1 X10  Y20.0  E0.0208",
    "G1 X30  Y20.0  E0.832",
    "G1 X30  Y19.5  E0.0208",
    "G1 X10  Y19.5  E0.832",
    "G1 X10  Y19.0  E0.0208",
    "G1 X30  Y19.0  E0.832",
    "G1 X30  Y18.5  E0.0208",
    "G1 X10  Y18.5  E0.832",
    "G1 X10  Y18.0  E0.0208",
    "G1 X30  Y18.0  E0.832",
    "G1 X30  Y17.5  E0.0208",
