...
SelftestFrametAxis::SelftestFrametAxis(window_t *parent, PhasesSelftest ph, fsm::PhaseData data)
    ...
    , icon_x_axis(this, png::Get<png::Id::x_axis_16x16>(), point_i16_t({ WizardDefaults::col_0, row_2 }))
    ...
    , icon_y_axis(this, png::Get<png::Id::y_axis_16x16>(), point_i16_t({ WizardDefaults::col_0, row_3 }))
    ...
    , icon_z_axis(this, png::Get<png::Id::z_axis_16x16>(), point_i16_t({ WizardDefaults::col_0, row_4 }))
