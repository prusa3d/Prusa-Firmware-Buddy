...
SelftestFrametAxis::SelftestFrametAxis(window_t *parent, PhasesSelftest ph, fsm::PhaseData data)
    ...
    , footer(this, footer::items::ItemAxisX, footer::items::ItemAxisY, footer::items::ItemAxisZ)
    , progress(this, WizardDefaults::row_1)
    , icon_x_axis(this, IDR_PNG_x_axis_16x16, point_i16_t({ WizardDefaults::col_0, row_2 }))
    ...
    , icon_y_axis(this, IDR_PNG_y_axis_16x16, point_i16_t({ WizardDefaults::col_0, row_3 }))
    ...
    , icon_z_axis(this, IDR_PNG_z_axis_16x16, point_i16_t({ WizardDefaults::col_0, row_4 }))
