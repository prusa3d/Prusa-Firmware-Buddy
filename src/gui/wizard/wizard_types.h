...
enum {
 ...
 _STATE_MASK_WIZARD =
    ...
    //disabled XYZ
    _STATE_MASK_WIZARD = _STATE_MASK_WIZARD_START | _STATE_MASK_SELFTEST | _STATE_MASK_FIRSTLAY | _STATE_MASK(_STATE_FINISH) | _STATE_MASK(_STATE_LAST),
};
