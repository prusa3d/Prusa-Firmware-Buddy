...
MI_LIVE_ADJUST_Z::MI_LIVE_ADJUST_Z()
    : WI_LABEL_t(_(label), png::Id::Null(), is_enabled_t::yes, is_hidden_t::no) {
}
...
MI_ENTER_DFU::MI_ENTER_DFU()
    : WI_LABEL_t(_(label), png::Id::Null(), is_enabled_t::yes, is_hidden_t::dev) {
}
...
static inline void MsgBoxNonBlockInfo(string_view_utf8 txt) {
    ...
    MsgBoxTitled mbt(GuiDefaults::DialogFrameRect, Responses_NONE, 0, nullptr, txt, is_multiline::yes, _(title), png::Id({ PNG::info_16x16 }));
    gui::TickLoop();
    gui_loop();
}
...
MI_TIMEOUT::MI_TIMEOUT()
    : WI_SWITCH_OFF_ON_t(Screens::Access()->GetMenuTimeout() ? 1 : 0, _(label), png::Id::Null(), is_enabled_t::yes, is_hidden_t::no) {}
...
MI_SOUND_MODE::MI_SOUND_MODE()
    : WI_SWITCH_t<MI_SOUND_MODE_COUNT>(init_index(), _(label), png::Id::Null(), is_enabled_t::yes, is_hidden_t::no,
...
MI_SOUND_TYPE::MI_SOUND_TYPE()
    : WI_SWITCH_t<8>(0, _(label), png::Id::Null(), is_enabled_t::yes, is_hidden_t::no,
...
MI_SOUND_VOLUME::MI_SOUND_VOLUME()
    : WiSpinInt(static_cast<uint8_t>(Sound_GetVolume()), SpinCnf::volume_range, _(label), png::Id::Null(), is_enabled_t::yes, is_hidden_t::no) {}
...
MI_SORT_FILES::MI_SORT_FILES()
    : WI_SWITCH_t<2>(eeprom_get_ui8(EEVAR_FILE_SORT), _(label), png::Id::Null(), is_enabled_t::yes, is_hidden_t::no, _(str_time), _(str_name)) {}
...
MI_TIMEZONE::MI_TIMEZONE()
    : WiSpinInt(eeprom_get_i8(EEVAR_TIMEZONE), SpinCnf::timezone_range, _(label), png::Id::Null(), is_enabled_t::yes, is_hidden_t::no) {}
...
MI_FILAMENT_SENSOR_STATE::MI_FILAMENT_SENSOR_STATE()
    : WI_SWITCH_0_1_NA_t(get_state(), _(label), png::Id::Null(), is_enabled_t::no, is_hidden_t::no) {
}
...
MI_FAN_CHECK::MI_FAN_CHECK()
    : WI_SWITCH_OFF_ON_t(marlin_get_bool(MARLIN_VAR_FAN_CHECK_ENABLED), _(label), png::Id::Null(), is_enabled_t::yes, is_hidden_t::no) {}
...
MI_FS_AUTOLOAD::MI_FS_AUTOLOAD()
    : WI_SWITCH_OFF_ON_t(marlin_get_bool(MARLIN_VAR_FS_AUTOLOAD_ENABLED), _(label), png::Id::Null(), is_enabled_t::yes, hide_autoload_item()) {}
...
MI_ODOMETER_DIST::MI_ODOMETER_DIST(string_view_utf8 label, png::Id id_icon, is_enabled_t enabled, is_hidden_t hidden, float initVal)
...
MI_ODOMETER_DIST_X::MI_ODOMETER_DIST_X()
    : MI_ODOMETER_DIST(_(label), png::Id::Null(), is_enabled_t::yes, is_hidden_t::no, -1) {
}
...
MI_ODOMETER_TIME::MI_ODOMETER_TIME()
    : WI_FORMATABLE_LABEL_t<uint32_t>(_(label), png::Id::Null(), is_enabled_t::yes, is_hidden_t::no, 0, [&](char *buffer) {
