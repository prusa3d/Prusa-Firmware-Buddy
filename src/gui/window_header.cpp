...
window_header_t::window_header_t(window_t *parent, string_view_utf8 txt)
    ...
    , icon_base(this, Rect16(GetRect().TopLeft(), icon_base_width, Height() - 5), nullptr)
    , label(this, GetRect() - Rect16::Width_t(icons_width + span + icon_base_width) + Rect16::Left_t(icon_base_width), txt, Align_t::LeftCenter())
    ...
    icon_base.SetAlignment(Align_t::Center());
