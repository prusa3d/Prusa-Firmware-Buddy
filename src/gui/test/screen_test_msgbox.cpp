...
screen_test_msgbox_data_t::screen_test_msgbox_data_t()
    ...
    , tst_ok(this, rect_ui16(10, 76, 220, 22), []() { MsgBox(Responses_Ok, test_text_view); })                              //Call_BtnOk<MsgBoxBase>(test_text_view); })
    , tst_okcancel(this, rect_ui16(10, 98, 220, 22), []() { MsgBox(Responses_OkCancel, test_text_view); })                  //Call_BtnOkCancel<MsgBoxBase>(test_text_view); })
    , tst_abortretryignore(this, rect_ui16(10, 120, 220, 22), []() { MsgBox(Responses_AbortRetryIgnore, test_text_view); }) //Call_BtnAbortRetryIgnore<MsgBoxTitled>(test_text_view, test_header_view,IDR_PNG_header_icon_error); })
    , tst_yesnocancel(this, rect_ui16(10, 142, 220, 22), []() { MsgBox(Responses_YesNoCancel, test_text_view); })           //Call_BtnYesNoCancel<MsgBoxTitled>(test_text_view, test_header_view, IDR_PNG_header_icon_question); })
