...
screen_test_msgbox_data_t::screen_test_msgbox_data_t()
    ...
    , tst_ok(this, rect_ui16(10, 76, 220, 22), []() { Call_BtnOk<MsgBoxBase>(test_text_view); })
    , tst_okcancel(this, rect_ui16(10, 98, 220, 22), []() { Call_BtnOkCancel<MsgBoxBase>(test_text_view); })
