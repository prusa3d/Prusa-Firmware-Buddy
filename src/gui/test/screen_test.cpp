...
public:
    MI_STACK_OVERFLOW()
        : WI_LABEL_t(_("Stack overflow"), png::Id::Null(), is_enabled_t::yes, is_hidden_t::no, expands_t::yes) {
    }
...
public:
    MI_DIV0()
        : WI_LABEL_t(_("BSOD div 0"), png::Id::Null(), is_enabled_t::yes, is_hidden_t::no, expands_t::yes) {
    }
