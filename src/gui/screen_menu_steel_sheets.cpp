...
public:
    MI_SHEET_OFFSET()
        : WI_LAMBDA_LABEL_t(_(label), png::Id::Null(), is_enabled_t::yes, is_hidden_t::yes, [this](char *buffer) {
...
struct ProfileRecord : public WI_LABEL_t {
    ...
    ProfileRecord()
        : WI_LABEL_t(string_view_utf8::MakeNULLSTR(), png::Id::Null(), is_enabled_t::yes, is_hidden_t::no) {
