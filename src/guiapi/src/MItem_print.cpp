...
//MI_NOZZLE
MI_NOZZLE::MI_NOZZLE()
    : WI_SPIN_INT_t(uint16_t(marlin_vars()->target_nozzle),
...
MI_HEATBED::MI_HEATBED()
    : WI_SPIN_INT_t(uint8_t(marlin_vars()->target_bed),
...
MI_PRINTFAN::MI_PRINTFAN()
    : WI_SPIN_INT_t(uint8_t(marlin_vars()->fan_speed),
...
//MI_SPEED
MI_SPEED::MI_SPEED()
    : WI_SPIN_INT_t(uint16_t(marlin_vars()->print_speed),
...
MI_FLOWFACT::MI_FLOWFACT()
    : WI_SPIN_INT_t(uint16_t(marlin_vars()->flow_factor),
