...
IWindowMenuItem::IWindowMenuItem(string_view_utf8 label, png::Id id_icon, is_enabled_t enabled, is_hidden_t hidden, expands_t expands, font_t *label_font)
    : IWindowMenuItem(label, expands == expands_t::yes ? expand_icon_width : Rect16::Width_t(0), id_icon, enabled, hidden, label_font) {
}

IWindowMenuItem::IWindowMenuItem(string_view_utf8 label, Rect16::Width_t extension_width_, png::Id id_icon, is_enabled_t enabled, is_hidden_t hidden, font_t *label_font)
    : label(label)
