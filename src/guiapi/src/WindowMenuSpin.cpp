...
IWiSpin::IWiSpin(SpinType val, string_view_utf8 label, png::Id id_icon, is_enabled_t enabled, is_hidden_t hidden, string_view_utf8 units_, size_t extension_width_)
...
WI_SPIN_CRASH_PERIOD_t::WI_SPIN_CRASH_PERIOD_t(int val, const Config &cnf, string_view_utf8 label, png::Id id_icon, is_enabled_t enabled, is_hidden_t hidden)
