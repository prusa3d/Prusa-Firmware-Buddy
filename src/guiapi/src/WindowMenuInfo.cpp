...
/*****************************************************************************/
// IWiInfo
IWiInfo::IWiInfo(string_view_utf8 label, png::Id id_icon, size_t info_len, is_enabled_t enabled, is_hidden_t hidden)
    : AddSuper<WI_LABEL_t>(label, !id_icon.IsNull() ? icon_width : info_len * InfoFont->w, id_icon, enabled, hidden) {}
