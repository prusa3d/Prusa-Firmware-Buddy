...
typedef void(display_draw_char_t)(point_ui16_t pt, char chr, const font_t *pf, color_t clr0, color_t clr1);
typedef void(display_draw_text_t)(rect_ui16_t rc, const char *str, const font_t *pf, color_t clr0, color_t clr1);
