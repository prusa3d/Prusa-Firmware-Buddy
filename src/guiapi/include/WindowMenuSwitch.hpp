...
public:
    ...
    struct Items_t {
        ...
        //icon ctor
        Items_t(png::Id array[], size_t SZ)
...
protected:
    ...
    using IconMemSpace_t = std::aligned_storage<sizeof(png::Id), alignof(png::Id)>;
...
public:
    IWiSwitch(int32_t index, string_view_utf8 label, png::Id id_icon, is_enabled_t enabled, is_hidden_t hidden, Items_t items_);
...
public:
    template <class... E>
    WI_SWITCH_t(int32_t index, string_view_utf8 label, png::Id id_icon, is_enabled_t enabled, is_hidden_t hidden, E &&... e)
...
public:
    template <class... E>
    WI_ICON_SWITCH_t(int32_t index, string_view_utf8 label, png::Id id_icon, is_enabled_t enabled, is_hidden_t hidden, E &&... e)
        : IWiSwitch(index, label, id_icon, enabled, hidden, FillArray<png::Id>(&ArrayMemSpace, std::forward<E>(e)...)) {}
};
