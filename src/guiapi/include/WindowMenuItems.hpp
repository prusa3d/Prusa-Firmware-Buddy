...
public:
    WI_SWITCH_OFF_ON_t(bool index, string_view_utf8 label, png::Id id_icon, is_enabled_t enabled, is_hidden_t hidden)
...
public:
    ...
    WI_SWITCH_0_1_NA_t(state_t index, string_view_utf8 label, png::Id id_icon, is_enabled_t enabled, is_hidden_t hidden)
