...
extern void render_text_align(void *context, rect_ui16_t rc, const char *text, font_t *font, color_t clr0, color_t clr1, padding_ui8_t padding, uint8_t align, uint8_t ml_mode);
