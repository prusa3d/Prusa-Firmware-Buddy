...
public:
    IWiSpin(SpinType val, string_view_utf8 label, png::Id id_icon, is_enabled_t enabled, is_hidden_t hidden, string_view_utf8 units_, size_t extension_width_);
...
public:
    WI_SPIN_t(T val, const Config &cnf, string_view_utf8 label, png::Id id_icon = png::Id::Null(), is_enabled_t enabled = is_enabled_t::yes, is_hidden_t hidden = is_hidden_t::no);
...
//WI_SPIN_t
template <class T>
WI_SPIN_t<T>::WI_SPIN_t(T val, const Config &cnf, string_view_utf8 label, png::Id id_icon, is_enabled_t enabled, is_hidden_t hidden)
...
public:
    WI_SPIN_CRASH_PERIOD_t(int val, const Config &cnf, string_view_utf8 label, png::Id id_icon = png::Id::Null(), is_enabled_t enabled = is_enabled_t::yes, is_hidden_t hidden = is_hidden_t::no);
    virtual invalidate_t change(int dif) override;
    /// returns the same type to be on the safe side (SpinType is not type safe)
