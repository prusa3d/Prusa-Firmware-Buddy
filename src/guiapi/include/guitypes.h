...
static const uint32_t COLOR_WHITE = 0x00ffffffL;
static const uint32_t COLOR_RED = 0x000000ffL;
static const uint32_t COLOR_RED_ALERT = 0x002646e7L;
static const uint32_t COLOR_LIME = 0x0000ff00L;
static const uint32_t COLOR_BLUE = 0x00ff0000L;
static const uint32_t COLOR_YELLOW = 0x0000ffffL;
static const uint32_t COLOR_CYAN = 0x00ffff00L;
static const uint32_t COLOR_MAGENTA = 0x00ff00ffL;
static const uint32_t COLOR_SILVER = 0x00c0c0c0L;
static const uint32_t COLOR_GRAY = 0x00808080L;
static const uint32_t COLOR_MAROON = 0x00000080L;
static const uint32_t COLOR_OLIVE = 0x00008080L;
static const uint32_t COLOR_GREEN = 0x00008000L;
static const uint32_t COLOR_PURPLE = 0x00800080L;
static const uint32_t COLOR_TEAL = 0x00808000L;
static const uint32_t COLOR_NAVY = 0x00800000L;
static const uint32_t COLOR_ORANGE = 0x001B65F8L;
static const uint32_t COLOR_DARK_KHAKI = 0x006BD7DBL;
