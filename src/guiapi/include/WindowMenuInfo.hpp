...
public:
    IWiInfo(string_view_utf8 label, png::Id id_icon, size_t info_len, is_enabled_t enabled, is_hidden_t hidden);
    IWiInfo(uint32_t num_to_print, string_view_utf8 label, is_hidden_t hidden = is_hidden_t::no, png::Id id_icon = png::Id::Null());
...
public:
    WiInfo(string_view_utf8 label, png::Id id_icon, is_enabled_t enabled, is_hidden_t hidden)
        : AddSuper<IWiInfo>(label, id_icon, INFO_LEN, enabled, hidden) {}
    WiInfo(uint32_t num_to_print, string_view_utf8 label, is_hidden_t hidden = is_hidden_t::no, png::Id id_icon = png::Id::Null())
...
public:
    WiInfoDev(string_view_utf8 label, png::Id id_icon, is_enabled_t enabled = is_enabled_t::yes)
        : AddSuper<WiInfo<INFO_LEN>>(label, id_icon, enabled, is_hidden_t::dev) {}
    WiInfoDev(uint32_t num_to_print, string_view_utf8 label, png::Id id_icon = png::Id::Null())
