...
class txtroll_t {
    ...
    void renderTextAlign(Rect16 rc, const string_view_utf8 &text, Font font, color_t clr_back, color_t clr_text, padding_ui8_t padding, Align_t alignment, bool fill_rect) const;
...
public:
    ...
    invalidate_t Tick();
    void RenderTextAlign(Rect16 rc, const string_view_utf8 &text, Font font, color_t clr_back, color_t clr_text, padding_ui8_t padding, Align_t alignment, bool fill_rect = true) const;
