...
struct GuiDefaults {
    ...
    //cannot use  "static constexpr padding_ui8_t Padding = { 2, 2, 2, 2 };", gettin linker error, i think optimizes it out
    static constexpr padding_ui8_t PaddingGet() { return { 2, 2, 2, 2 }; }
