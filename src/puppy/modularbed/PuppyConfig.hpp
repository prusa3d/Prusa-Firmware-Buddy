...
#define OVERCURRENT_THRESHOLD_AMPS_A 10.5f
#define OVERCURRENT_THRESHOLD_AMPS_B 6.3f

#define UNEXPECTED_CURRENT_TOLERANCE_A 2.0f
#define UNEXPECTED_CURRENT_TOLERANCE_B 1.2f
...
#define PWM_MAX_CURRENT_AMPS_A 10
#define PWM_MAX_CURRENT_AMPS_B 6
