...
#if FSDATA_FILE_ALIGNMENT == 1
static const unsigned int dummy_align__admin_html = 1;
#endif
static const unsigned char FSDATA_ALIGN_PRE data__admin_html[] FSDATA_ALIGN_POST = {
    /* /admin.html (12 chars) */
    0x2f,
    0x61,
    0x64,
...
#if FSDATA_FILE_ALIGNMENT == 1
static const unsigned int dummy_align__connect_black_svg = 2;
#endif
...
#if FSDATA_FILE_ALIGNMENT == 1
static const unsigned int dummy_align__favicon_ico = 3;
#endif
...
const struct fsdata_file file__admin_html[] = { {
    file__404_html,
    data__admin_html,
    data__admin_html + 12,
    sizeof(data__admin_html) - 12,
    FS_FILE_FLAGS_HEADER_INCLUDED | FS_FILE_FLAGS_HEADER_PERSISTENT,
} };
