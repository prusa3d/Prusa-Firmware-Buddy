...
#define FSM_CREATE_WITH_DATA__LOGGING(fsm_type, phase, data)          fsm_create(ClientFSM::fsm_type, phase, data, __PRETTY_FUNCTION__, __FILE__, __LINE__)
#define FSM_CREATE__LOGGING(fsm_type)                                 _fsm_create(ClientFSM::fsm_type, fsm::BaseData(), __PRETTY_FUNCTION__, __FILE__, __LINE__)
#define FSM_DESTROY_AND_CREATE__LOGGING(fsm_old, fsm_new)             _fsm_destroy_and_create(ClientFSM::fsm_old, ClientFSM::fsm_new, fsm::BaseData(), __PRETTY_FUNCTION__, __FILE__, __LINE__)
...
#define FSM_HOLDER__LOGGING(fsm_type)                        FSM_Holder fsm_type##_from_macro(ClientFSM::fsm_type, __PRETTY_FUNCTION__, __FILE__, __LINE__)
#define FSM_HOLDER_WITH_DATA__LOGGING(fsm_type, phase, data) FSM_Holder fsm_type##_from_macro(data, phase, ClientFSM::fsm_type, __PRETTY_FUNCTION__, __FILE__, __LINE__)
