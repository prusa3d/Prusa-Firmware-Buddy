...
class ClientResponses {
    ...
    static constexpr EnumArray<PhasesLoadUnload, PhaseResponses, CountPhases<PhasesLoadUnload>()> LoadUnloadResponses {
        { PhasesLoadUnload::initial, {} },
            ...
            { PhasesLoadUnload::FilamentNotInFS, {} },
            { PhasesLoadUnload::ManualUnload, { Response::Continue, Response::Retry } },
            ...
            { PhasesLoadUnload::MakeSureInserted_stoppable, { Response::Stop } },
            { PhasesLoadUnload::MakeSureInserted_unstoppable, {} },
