...
static constexpr err_t error_list[] = {
    ...
    { { ERR_CAT_THERMAL,
        ...
        "",
        "Heating Failed E1",
        "Check the" NBSP "print head heater &" NBSP "thermistor wiring for" NBSP "possible damage.",
        ECODE_201 },
    { { ERR_CAT_THERMAL,
        ...
        "",
        "Heating Failed Bed",
        "Check the" NBSP "bed heater &" NBSP "thermistor wiring for" NBSP "possible damage.",
        ECODE_201 },
    { { ERR_CAT_THERMAL,
          ERR_CAT_THERMAL_SUBCAT_HOTEND,
        ...
        "",
        "Therm. Runaway E1",
        "Check the" NBSP "print head thermistor wiring for" NBSP "possible damage.",
        ECODE_202 },
    { { ERR_CAT_THERMAL,
          ERR_CAT_THERMAL_SUBCAT_BED,
        ...
        "",
        "Therm. Runaway Bed",
        "Check the" NBSP "bed thermistor wiring for" NBSP "possible damage.",
        ECODE_202 },
    { { ERR_CAT_THERMAL,
          ERR_CAT_THERMAL_SUBCAT_HOTEND,
    ...
    { { ERR_CAT_THERMAL,
        ...
        "",
        "Inactive Time Kill",
        "Internal scheduler error. Restart the" NBSP "printer.",
        ECODE_205 },
    { { ERR_CAT_SYSTEM,
        ...
        "",
        "M112 Shutdown",
        "Emergency stop M112, restart the" NBSP "printer.",
        ECODE_506 },
    { { ERR_CAT_SYSTEM,
          ERR_CAT_SYSTEM_SUBCAT_INTERNAL,
        ...
        "",
        "Firmware Error",
        "Firmware corrupted! Please flash the" NBSP "firmware again.",
        ECODE_508 },
    { { ERR_CAT_ELECTRO,
        ...
        "",
        "Homing Error",
        "Check MINDA cable (connected and" NBSP "not damaged).",
        ECODE_309 },
    { { ERR_CAT_ELECTRO,
          ERR_CAT_ELECTRO_SUBCAT_MINDA,
        ...
        "",
        "MBL Error",
        "Ensure the" NBSP "sheet is correctly placed and" NBSP "check MINDA sensor connection.",
        ECODE_310 },
};
