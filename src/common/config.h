...
static const unsigned char MARLIN_SERVER_QUEUE = 128; // size of marlin server input character queue (number of characters)
static const unsigned char MARLIN_CLIENT_QUEUE = 16;  // size of marlin client input message queue (number of messages)
...
static const uint16_t UART2_SIG_RXCPL = 0x0004;
