...
extern const buddy::hw::OutputPin *Buzzer;
extern const buddy::hw::OutputPin *SideLed_LcdSelector;
extern const buddy::hw::OutputPin *XStep;
extern const buddy::hw::OutputPin *YStep;
