...
#define MARLIN_VAR_MAX      MARLIN_VAR_PRNSTATE
...
#define MARLIN_VAR_MSK_DEF ( \
    MARLIN_VAR_MSK(MARLIN_VAR_MOTION) | MARLIN_VAR_MSK(MARLIN_VAR_GQUEUE) | MARLIN_VAR_MSK_POS_XYZE | MARLIN_VAR_MSK_TEMP_ALL | MARLIN_VAR_MSK(MARLIN_VAR_SD_PRINT) | MARLIN_VAR_MSK(MARLIN_VAR_SD_PDONE) | MARLIN_VAR_MSK(MARLIN_VAR_DURATION) | MARLIN_VAR_MSK(MARLIN_VAR_MEDIAINS) | MARLIN_VAR_MSK(MARLIN_VAR_PRNSTATE))
