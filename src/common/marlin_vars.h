...
static const uint64_t MARLIN_VAR_MSK_TEMP_ALL
    = MARLIN_VAR_MSK(MARLIN_VAR_TEMP_NOZ) | MARLIN_VAR_MSK(MARLIN_VAR_TEMP_BED) | MARLIN_VAR_MSK(MARLIN_VAR_TTEM_NOZ) | MARLIN_VAR_MSK(MARLIN_VAR_TTEM_BED) | MARLIN_VAR_MSK(MARLIN_VAR_DTEM_NOZ) | MARLIN_VAR_MSK(MARLIN_VAR_PRINT_FAN_RPM) | MARLIN_VAR_MSK(MARLIN_VAR_PRINT_FAN_RPM);
