...
#define PIN_TABLE(MACRO_FUNCTION)                                                                                                                                                           \
    ...
    MACRO_FUNCTION(buddy::hw::InputPin, loadcellDout, buddy::hw::IoPort::A COMMA buddy::hw::IoPin::p3, IMode::input COMMA Pull::up, buddy::hw::noHandler)                                   \
    MACRO_FUNCTION(buddy::hw::OutputPin, loadcellSck, buddy::hw::IoPort::A COMMA buddy::hw::IoPin::p0, Pin::State::low COMMA OMode::pushPull COMMA OSpeed::very_high, buddy::hw::noHandler) \
