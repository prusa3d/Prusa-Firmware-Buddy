...
#define attachInterrupt(MARLIN_PIN, USER_FUNC, I_MODE)                                                                                                             \
    static_assert(buddy::hw::physicalPinExist(MARLIN_PIN), "Pin " #MARLIN_PIN " does not exist.");                                                                 \
    static_assert(buddy::hw::isInterruptPin(MARLIN_PIN), "Pin " #MARLIN_PIN " is not InterruptPin.");                                                              \
...
#include "../../lib/Marlin/Marlin/src/HAL/HAL_STM32_F4_F7/endstop_interrupts.h"
