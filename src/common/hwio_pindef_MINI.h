...
#define PIN_TABLE(F)                                                                                                                                    \
    ...
    F(InputPin, fastBoot, Pin::IoPortToHalBase(IoPort::C) COMMA Pin::IoPinToHal(IoPin::p7), IMode::input COMMA Pull::up)                                \
    F(InputPin, fSensor, Pin::IoPortToHalBase(IoPort::B) COMMA Pin::IoPinToHal(IoPin::p4), IMode::input COMMA Pull::up)                                 \
    F(OutputPin, fan0pwm, Pin::IoPortToHalBase(IoPort::E) COMMA Pin::IoPinToHal(IoPin::p11), InitState::reset COMMA OMode::pushPull COMMA OSpeed::high) \
    F(OutputPin, fan1pwm, Pin::IoPortToHalBase(IoPort::E) COMMA Pin::IoPinToHal(IoPin::p9), InitState::reset COMMA OMode::pushPull COMMA OSpeed::high)  \
    F(InputPin, fan0tach, Pin::IoPortToHalBase(IoPort::E) COMMA Pin::IoPinToHal(IoPin::p10), IMode::input COMMA Pull::up)                               \
    F(InputPin, fan1tach, Pin::IoPortToHalBase(IoPort::E) COMMA Pin::IoPinToHal(IoPin::p14), IMode::input COMMA Pull::up)                               \
    F(InputPin, jogWheelEN1, Pin::IoPortToHalBase(IoPort::E) COMMA Pin::IoPinToHal(IoPin::p15), IMode::input COMMA Pull::up)                            \
    F(InputPin, jogWheelEN2, Pin::IoPortToHalBase(IoPort::E) COMMA Pin::IoPinToHal(IoPin::p13), IMode::input COMMA Pull::up)                            \
    F(InputPin, jogWheelENC, Pin::IoPortToHalBase(IoPort::E) COMMA Pin::IoPinToHal(IoPin::p12), IMode::input COMMA Pull::up)                            \
    F(OutputPin, cs, Pin::IoPortToHalBase(IoPort::C) COMMA Pin::IoPinToHal(IoPin::p9), InitState::set COMMA OMode::pushPull COMMA OSpeed::high)         \
    F(OutputPin, rs, Pin::IoPortToHalBase(IoPort::D) COMMA Pin::IoPinToHal(IoPin::p11), InitState::set COMMA OMode::pushPull COMMA OSpeed::high)        \
    F(OutputInputPin, rst, Pin::IoPortToHalBase(IoPort::C) COMMA Pin::IoPinToHal(IoPin::p8), InitState::set COMMA OMode::pushPull COMMA OSpeed::low)
