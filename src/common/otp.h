...
static const uint32_t OTP_BOARD_REVISION_ADDR = 0x1FFF7800;
#define OTP_BOARD_REVISION_SIZE 3

// timestamp (seconds since 1970, little-endian)
static const uint32_t OTP_BOARD_TIME_STAMP_ADDR = 0x1FFF7804;
static const uint8_t OTP_BOARD_TIME_STAMP_SIZE = 4;

// serial number without first four characters "CZPX" (total 15 chars, zero terminated)
static const uint32_t OTP_SERIAL_NUMBER_ADDR = 0x1FFF7808;
#define OTP_SERIAL_NUMBER_SIZE 16

// mac address - xx:xx:xx:xx:xx:xx, six byte array
static const uint32_t OTP_MAC_ADDRESS_ADDR = 0x1FFF781A;
...
static const uint8_t OTP_LOCK_BLOCK_SIZE = 16;

// unique identifier 96bits
static const uint32_t OTP_STM32_UUID_ADDR = 0x1FFF7A10;
